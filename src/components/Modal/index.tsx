...
export function Modal() {
    const [newProductName, setNewProductName] = useState<registerNewProductName>("");
    const [newProductPrice, setNewProductPrice] = useState<registerNewProductPrice>();
    const [newProductSales, setNewProductSales] = useState<registerNewProductSales>();
    const [newProductStock, setNewProductStock] = useState<registerNewProductStock>();
                ...
                <DialogContent>
                    ...
                    <Flex css={{ marginTop: 25, justifyContent: 'flex-end' }}>
                        <Dialog.Close asChild>
                            <Button onClick={createProduct} disabled={isSubmitting}>Criar produto</Button>
                        </Dialog.Close>
                    </Flex>
                    <Dialog.Close asChild>
